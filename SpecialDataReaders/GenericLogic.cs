...
namespace Gerk.SpecialDataReaders
{
	...
	public static class ExtensionMethods
	{
		...
		public static IDataReader MapNullsToDBNulls(IDataReader dr) => new NullToDBNullDataReader(dr);
		...
		/// <param name="dr">the datareader</param>
		/// <returns>a new datareader with the mapping applied</returns>
		public static IDataReader MapDBNullsToNulls(IDataReader dr) => new DBNullToNullDataReader(dr);
	}
}
